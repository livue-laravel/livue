...
import { hook, getAvailableHooks } from './hooks.js';
import { isEchoAvailable, getDebugInfo as getEchoDebugInfo, leaveAll as leaveAllEchoChannels } from './echo.js';
...
class LiVueRuntime {
     ...
     */
    boot() {
        // Initialize devtools (lazy, doesn't open panel)
